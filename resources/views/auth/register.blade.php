...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card mt-4">
                <div class="card-body">
                    <h5 class="card-title">Тестовые аккаунты:</h5>
                    <p><strong>Админ:</strong> admin@mirea.ru / 1111</p>
                    <p><strong>Студент 1:</strong> student1@mirea.ru / student1</p>
                    <p><strong>Студент 2:</strong> student2@mirea.ru / student2</p>
                    <p><strong>Студент 3:</strong> student3@mirea.ru / student3</p>
                </div>
            </div>
        </div>
    </div>
